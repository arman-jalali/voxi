...
public extension Notification.Name {
    ...
    /// renders it.)
    static let gtSettingDidChange = Notification.Name("com.voxi.app.setting-changed")
    ...
    static let gtSmartFormattingAutoDegraded = Notification.Name("com.voxi.app.auto-degraded")
}
