...
final class StatusItemController: NSObject {
    ...
    init(
        ...
        statusItem.button?.toolTip = "Voxi"
    ...
    private func makeMenu() -> NSMenu {
        ...
        let about = NSMenuItem(title: "About Voxi", action: #selector(openAbout), keyEquivalent: "")
        about.target = self
        menu.addItem(about)

        let quit = NSMenuItem(title: "Quit Voxi", action: #selector(NSApplication.terminate(_:)), keyEquivalent: "q")
        menu.addItem(quit)
